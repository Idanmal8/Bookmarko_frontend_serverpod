...
import 'package:bookmarko_client/src/protocol/customers.dart' as _i16;
import 'package:bookmarko_client/src/protocol/payments.dart' as _i17;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.Customer) {
      return _i5.Customer.fromJson(data, this) as T;
    }
    if (t == _i6.Example) {
    ...
    if (t == _i1.getType<_i5.Customer?>()) {
      return (data != null ? _i5.Customer.fromJson(data, this) : null) as T;
    }
